# Implement data augmentation on a given image dataset using keras. Show atleast three different augmentation techniques and explain how they help improve model performance
import numpy as np
import matplotlib.pyplot as plt
from tensorflow.keras.preprocessing.image import ImageDataGenerator, array_to_img, img_to_array, load_img

img = load_img('apple.jpeg')  # Change to your image path
